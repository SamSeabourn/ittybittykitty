...
/* harmony default export */ const CarrierBottom = (__webpack_require__.p + "CarrierBottom.png");
;// CONCATENATED MODULE: ./src/components/catcarrier/CarrierTop.png
/* harmony default export */ const CarrierTop = (__webpack_require__.p + "CarrierTop.png");
;// CONCATENATED MODULE: ./src/components/catcarrier/CatCarrier.tsx




const CatCarrier = () => {
    return ((0,jsx_runtime.jsxs)("div", { className: 'carrier-wrapper', children: [(0,jsx_runtime.jsx)("div", { className: 'carrier-bottom', children: (0,jsx_runtime.jsx)("img", { src: CarrierBottom }) }), (0,jsx_runtime.jsx)("div", { className: 'carrier-top', children: (0,jsx_runtime.jsx)("img", { src: CarrierTop }) })] }));
};
/* harmony default export */ const catcarrier_CatCarrier = (CatCarrier);

;// CONCATENATED MODULE: ./src/components/catcarrier/index.ts
...
;// CONCATENATED MODULE: ./src/components/startmenubutton/StartMenuButton.tsx


const StartMenuButton = ({ startOpen, toggleStart }) => {
    const buttonClass = `start-menu-button${startOpen ? '__open' : ''}`;
    return ((0,jsx_runtime.jsx)("div", { className: buttonClass, onClick: e => toggleStart(e), children: (0,jsx_runtime.jsx)("span", { className: 'start-menu-button--text', children: "START" }) }));
};
/* harmony default export */ const startmenubutton_StartMenuButton = (StartMenuButton);

;// CONCATENATED MODULE: ./src/components/startmenubutton/index.tsx


;// CONCATENATED MODULE: ./src/components/startmenuoption/StartMenuOption.tsx


const StartMenuOption = ({ children, icon, optionFunction }) => {
    return ((0,jsx_runtime.jsxs)("div", { className: 'start-menu-option', onClick: optionFunction, children: [(0,jsx_runtime.jsx)("img", { className: 'start-menu-icon', src: icon }), " ", (0,jsx_runtime.jsx)("div", { children: children })] }));
};
/* harmony default export */ const startmenuoption_StartMenuOption = (StartMenuOption);

;// CONCATENATED MODULE: ./src/components/startmenu/cat_os97.png
/* harmony default export */ const cat_os97 = (__webpack_require__.p + "cat_os97.png");
;// CONCATENATED MODULE: ./src/components/startmenu/togglecat.png
/* harmony default export */ const togglecat = (__webpack_require__.p + "togglecat.png");
;// CONCATENATED MODULE: ./src/components/startmenu/getkitty.png
/* harmony default export */ const getkitty = (__webpack_require__.p + "getkitty.png");
;// CONCATENATED MODULE: ./src/components/startmenu/sponge.png
/* harmony default export */ const sponge = (__webpack_require__.p + "sponge.png");
;// CONCATENATED MODULE: ./src/components/startmenu/sponge_water.png
/* harmony default export */ const sponge_water = (__webpack_require__.p + "sponge_water.png");
;// CONCATENATED MODULE: ./src/components/startmenu/StartMenu.tsx
...
;// CONCATENATED MODULE: ./src/components/startmenu/index.ts


;// CONCATENATED MODULE: ./src/components/kitty/movement.ts
const actions = [
    'run',
    'stroll',
    'sleep',
...
;// CONCATENATED MODULE: ./src/components/kitty/Kitty.tsx
...
const Kitty = ({ id, name, color, colorShift, isClean, cleanKitty, spawnPoop, }) => {
    const minLeftPosition = 120;
    const position = (0,react.useRef)(minLeftPosition);
    ...
    const actionsStarted = (0,react.useRef)(false);
    const timeoutRef = (0,react.useRef)(0);
    ...
    const doStationaryAction = (actionName) => {
    ...
    const doMovementAction = (actionName) => {
        const movementSpeed = actionName === 'run' ? 250 : 125;
        const newLocation = generateRandomFromRange(minLeftPosition, window.innerWidth - 40);
    ...
    const doZoomies = () => {
        ...
        const zoomie = () => {
            if (locationsCount !== 0) {
                const newLocation = generateRandomFromRange(minLeftPosition, window.innerWidth - 40);
                const travelDistance = Math.abs(position.current - newLocation);
                let travelTime = Math.round((travelDistance / movementSpeed) * 1000);
                setDirection(newLocation < position.current ? 'left' : 'right');
                position.current = newLocation;
                setAction('run');
                setStyle(cssBuilder({
    ...
    const doJump = (e) => {
        if (!['idle', 'wag', 'wipe'].includes(action) || !isClean)
            return;
    ...
    const doNextAction = () => {
        ...
        if (['idle', 'wag', 'lick'].includes(previousAction) &&
        ...
        switch (newAction) {
            ...
            case 'sleep':
                ...
                if (!['run', 'stroll', 'zoomies', 'jump'].includes(previousAction)) {
    ...
    return ((0,jsx_runtime.jsx)("div", { style: style, className: 'kitty__wrapper', children: (0,jsx_runtime.jsx)("div", { style: {
                backgroundImage: kittenSprite,
                transform: direction === 'left' ? 'scaleX(-1) scale(4)' : '',
            }, className: `kitty-test-${action} kitty ${color === 'gold' && isClean ? 'gold' : ''}`, onMouseEnter: e => doJump(e), children: (0,jsx_runtime.jsx)("div", { className: 'kitty__boundingbox', onClick: handleCleanKitty }) }) }));
};
/* harmony default export */ const kitty_Kitty = (Kitty);

;// CONCATENATED MODULE: ./src/components/kitty/index.tsx


;// CONCATENATED MODULE: ./src/components/startmenu/sponge_solo.png
/* harmony default export */ const sponge_solo = (__webpack_require__.p + "sponge_solo.png");
;// CONCATENATED MODULE: ./src/components/poop/Poop.tsx



const Poop = ({ id, location, removePoop }) => {
    return ((0,jsx_runtime.jsx)("div", { className: 'poop', style: {
            backgroundImage: `url('./poop_fresh.png')`,
            left: `${location}px`,
        }, onClick: () => removePoop(id) }));
};
/* harmony default export */ const poop_Poop = (Poop);

;// CONCATENATED MODULE: ./src/components/poop/index.tsx
...
;// CONCATENATED MODULE: ./src/components/oswindow/index.tsx
...
;// CONCATENATED MODULE: ./src/components/score/constants.ts
const SCORE = {
    GET_KITTEN: 1000,
    CLEAN_KITTEN: 200,
    CLEAN_POOP: 100,
...
const Playground = () => {
    ...
    const [showKittens, setShowKittens] = (0,react.useState)(true);
    const [kittens, setKittens] = (0,react.useState)([]);
    ...
    const addKittenToLocalStorage = (newKitten) => {
        const storageString = localStorage.getItem('kittenStorage');
        const existingKittens = JSON.parse(storageString);
        localStorage.setItem('kittenStorage', JSON.stringify([...existingKittens, newKitten]));
    };
    ...
    const updateKittenInLocalStorage = (id, key, value) => {
        const storageString = localStorage.getItem('kittenStorage');
        let existingKittens = JSON.parse(storageString);
        for (let i = 0; i < existingKittens.length; i++) {
            if (existingKittens[i].id === id) {
                existingKittens[i][key] = value;
                localStorage.setItem('kittenStorage', JSON.stringify([...existingKittens]));
            }
        }
    };
    const spawnPoop = (location) => {
        if (poop.length >= 2)
            return; //max poop is 20 TODO: this is broken somehow
        const newPoop = {
            id: createUUID(),
...
function App() {
    return ((0,jsx_runtime.jsx)("div", { className: "App", children: (0,jsx_runtime.jsx)(playground_Playground, {}) }));
}
...
const root = (0,client/* createRoot */.s)(container); //Not yet supported
